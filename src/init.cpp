...
std::string HelpMessage(HelpMessageMode mode)
{
	...
	strUsage += "  -conf=<file>           " + strprintf(_("Specify configuration file (default: %s)"), "DIGI.conf") + "\n";
...
#ifndef WIN32
	strUsage += "  -pid=<file>            " + strprintf(_("Specify pid file (default: %s)"), "DIGId.pid") + "\n";
#endif
	...
	strUsage += "  -port=<port>           " + strprintf(_("Listen for connections on <port> (default: %u or testnet: %u)"), 8138, 18138) + "\n";
	...
	strUsage += "\n" + _("RPC SSL options: (see the DIGI Wiki for SSL setup instructions)") + "\n";
...
std::string LicenseInfo()
{
	return FormatParagraph(strprintf(_("Copyright (C) 2009-%i The Bitcoin Core Developers"), COPYRIGHT_YEAR)) + "\n" +
			"\n" +
			FormatParagraph(strprintf(_("Copyright (C) 2011-%i The DIGI Developers"), COPYRIGHT_YEAR)) + "\n" +
			"\n" +
...
#define PROCESS_DEP_ENABLE 0x00000001
	...
	// Sanity check
	if (!InitSanityCheck())
		return InitError(_("Initialization sanity check failed. DIGI is shutting down."));
	...
	if (!lock.try_lock())
		//<<<<<<< HEAD
		return InitError(strprintf(_("Cannot obtain a lock on data directory %s. DIGI is probably already running."), strDataDir));
#ifndef WIN32
